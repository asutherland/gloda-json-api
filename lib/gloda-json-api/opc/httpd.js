 ...
 */
var nsHttpServer = exports.nsHttpServer = function nsHttpServer()
{
  if (!gThreadManager)
...
nsHttpServer.prototype =
{
  ...
  _notifyStopped: function()
  {
    ...
    catch (e)
    {
      ...
      // always) asynchronous
      console.error("!!! error running onStopped callback: " + e + "\n");
    }
  },
  ...
  _writeFileResponse: function(metadata, file, response, offset, count)
  {
    ...
    if (type === SJS_TYPE)
    {
      ...
      try
      {
        ...
        {
          console.error("*** error running SJS at " + file.path + ": " +
                        e + " on line " +
                        (e instanceof Error
...
Request.prototype =
{
  ...
  // Read the entire request body and return its
  // contents as a string.
  readBody: function()
  {
    var stream = new ScriptableInputStream(this._bodyInputStream);
    return stream.read(PR_UINT32_MAX);
  },
